...
class WebNeuroCompatible(ParentNeuro):
    ...
    def get_var_mapping(cls):
        ...
        mapping = [
            ...
            'chlrrtav',
            'ctmsco13',
            *['getcp' + i for i in emotions],
            *['getrt' + i for i in emotions],
            'digitsp',
            'digitot',
            *['vcrtne' + i for i in ['', '2']],
            *['vi_sco' + i for i in ['1', '2']],
            *['vi_err' + i for i in ['1', '2']],
            'vi_difrt',
            *['scavr0t' + i for i in ['1', '2']],
            *['esoadur' + i for i in ['1', '2']],
            *['esoaerr' + i for i in ['1', '2']],
            'g2avrtk',
            'g2fnk',
            'g2fpk',
            'g2errk',
            'g2sdrtk',
            'ctmrec4',
            *['dgtrt' + i for i in emotions],
            *['dgtcn' + i for i in emotions[:-1]],
            'wmfnk',
            'wmfpk',
            'wmacck',
            'wmrtk',
